...
public class SetGame extends Game
{
    ...
    public void initResources ()
    {
        ...
        Buttons button = new Buttons("Happy", 10, 140, 60, 40, getImage("resources/happy.jpg"),"resources/happy.jpg", "enemy");
 
        Buttons bowserbutton = new Buttons("Bowser", 100, 140, 60, 40, getImage("resources/Bowser.jpg"), "resources/Bowser.jpg", "enemy");
        ...
        Buttons platformbutton1 = new Buttons ("Platform1", 10, 240, 60, 40, getImage ("resources/platform1.png"), "resources/platform1.png", "platform");
        Buttons platformbutton2 = new Buttons ("Platform2", 100, 240, 60, 40, getImage ("resources/platform2.png"), "resources/platform2.png","platform");
        ...
        if(click())
        {
            for(Buttons button: allButtons)
            {
                ...
                if(button.getClicked()){
                    ...
                    {
                        s = new Platform(button.getImage(), getMouseX(), getMouseY()-button.getImage().getHeight(), button.getImageName());
                    }
                    if(button.getType().equals("enemy"))
                    {
                        s = new Enemy(button.getImage(), getMouseX(), getMouseY()-button.getImage().getHeight(), button.getImageName());
                    }
    ...
    {
        String selectedValue = JOptionPane.showInputDialog("Where would you like to save the level?");
